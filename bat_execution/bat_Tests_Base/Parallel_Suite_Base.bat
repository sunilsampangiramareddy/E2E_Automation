...
pytest -n 5 tests_SFDC_Base\TC_Login.py tests_SFDC_Base\TC_CreateOpportunity.py tests_CPQ_Base\TC_API_Validation.py tests_CPQ_Base\TC_Copy_Quote.py tests_CPQ_Base\TC_Open_Quote.py tests_CPQ_Base\TC_FAS_AFF_Cluster_Config.py --browser_type=chromium --url=https://netapp2--uat.sandbox.lightning.force.com/ --headed --reruns 2 --junitxml=failed_report.xml --report_name=Parallel_Suite_Base
