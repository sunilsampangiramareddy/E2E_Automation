...
# Test Metadata
# =========================================================================================================================
# Test Scenario: Verify that a user can log in to the Partner Portal and copy a quote successfully.
# Test Description: This test script automates the process of logging into the Partner Portal, navigating
#                   to the Quote Console, copying a quote, and capturing its details, including product and pricing
#                   information from the LIG product table.
# Author: Sunil Reddy
# =========================================================================================================================

logger = logging.getLogger("playwright_pytest")
# Load test data from Excel
relative_file_path = os.path.join("testData", "TC_Partner_Copy_Quote.xlsx")
...
@pytest.mark.smoke
@pytest.mark.master
def test_Partner_Copy_Quote(page: Page, base_url, config, test_case) -> None:
    ...
    try:
        ...
        # ========================Navigate to Quotes Console page and click on the Copy quote=========================================================================
        ...
        new_tab = pqp.copyQuote()
        logger.info("Clicked on Copy Quote")
        ...
        test_results = [
            ...
            [script_name, boolean_status, "Quote copiedsuccessfully"],
        ]
