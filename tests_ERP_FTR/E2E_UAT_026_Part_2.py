...
#                (Data Infrastructure Insights)) and Storage Grid(SG5812), submit a quote through B2B XML and
#                validate quote status in TPD.
...
#                   Override Invalid/LOD Part, Initiate Approval Request, Generate and Export B2B XML for Quote submission
#                   and validating the quote status in TPD.
# Author: Sunil Reddy
# =========================================================================================================================

logger = logging.getLogger("playwright_pytest")
# Load test data from Excel
relative_file_path = os.path.join("testData/tests_ERP_FTR", "E2E_UAT_026_Part_2.xlsx")
...
def test_E2E_UAT_026_Part_2(page: Page, base_url, config, test_case) -> None:
    lp = LoginPage(page)
    hp = HomePage(page)
