...
#                (Data Infrastructure Insights)) and Storage Grid(SG5812), submit a quote through B2B XML
#                and validate quote status in TPD.
...
#                   (Data Infrastructure Insights)) and Storage Grid(SG5812), updating its details in the
#                   Account Information, Initiate Approval Request, Override Invalid/LOD Part, GTC Risks,
...
relative_file_path = os.path.join("testData/tests_ERP_FTR", "E2E_UAT_022_Part_1.xlsx")
...
def test_E2E_UAT_022_Part_1(page: Page, base_url, config, test_case) -> None:
    lp = LoginPage(page)
    hp = HomePage(page)
