...
# Test Metadata
# =========================================================================================================================
# Test Scenario: Verify that a user can create a Salesforce opportunity, configure Keystone product
#                (Keystone Storage-as-a-Service v3), submit a quote, and approve the quote in TPD
#
# Test Description: This test script automates the process of logging into Salesforce, creating an Direct opportunity,
#                   configuring Keystone product(Keystone Storage-as-a-Service v3), updating their details in the
...
relative_file_path = os.path.join("testData/tests_ERP_FTR", "E2E_UAT_003_Part_2.xlsx")
...
def test_E2E_UAT_003_Part_2(page: Page, base_url, config, test_case) -> None:
    lp = LoginPage(page)
    hp = HomePage(page)
