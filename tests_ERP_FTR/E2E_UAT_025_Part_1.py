...
#                parts(X65404), submit a quote, and approve the quote in TPD
...
#                   Attachments and Purchase Order tabs and validating the quote status by approving the quote in TPD.
# Author: Sunil Reddy
# =========================================================================================================================

logger = logging.getLogger("playwright_pytest")
# Load test data from Excel
relative_file_path = os.path.join("testData/tests_ERP_FTR", "E2E_UAT_025_Part_1.xlsx")
...
def test_E2E_UAT_025_Part_1(page: Page, base_url, config, test_case) -> None:
    lp = LoginPage(page)
    hp = HomePage(page)
