...
#                   (Data Infrastructure Insights)) and Storage Grid(SG5812), updating their details in the
#                   Account Information, Approval Request, GTC Risks, Override Invalid/LOD Part, Attachments
#                   and Purchase Order tabs and validating the quote status by approving the quote in TPD.
# Author: Sunil Reddy
# =========================================================================================================================

logger = logging.getLogger("playwright_pytest")
# Load test data from Excel
relative_file_path = os.path.join("testData/tests_ERP_FTR", "E2E_UAT_022_Part_2.xlsx")
...
def test_E2E_UAT_022_Part_2(page: Page, base_url, config, test_case) -> None:
    lp = LoginPage(page)
    hp = HomePage(page)
