...
# Test Metadata
# =========================================================================================================================
# Test Scenario: Verify that a user can configure multiple products (FAS/AFF/ASA/AFX(FAS8300) and Cloud & Data Services(DII))
#                ,submit a quote, and approve the quote in TPD after fulfilling the required details in Salesforce and CPQ.
# Test Description: This test script automates the end-to-end process of logging into Salesforce, creating a Direct
#                   opportunity, configuring multiple products (FAS/AFF/ASA/AFX(FAS8300) and Cloud & Data Services(DII)),
...
relative_file_path = os.path.join("testData/tests_ERP_FTR", "E2E_UAT_017.xlsx")
...
def test_E2E_UAT_017(page: Page, base_url, config, test_case) -> None:
    lp = LoginPage(page)
    hp = HomePage(page)
