...
# Test Metadata
# =========================================================================================================================
# Test Scenario: Verify that a user can configure Quick Ship/Express Pack parts (X65404), submit a quote and approve
#                the quote in TPD.
# Test Description: This test script automates the process of logging into Salesforce, creating a Direct opportunity,
#                   configuring Quick Ship/Express Pack parts (X65404), updating its details in the Account Information,
...
relative_file_path = os.path.join("testData/tests_ERP_FTR", "E2E_UAT_051.xlsx")
...
def test_E2E_UAT_051(page: Page, base_url, config, test_case) -> None:
    lp = LoginPage(page)
    hp = HomePage(page)
